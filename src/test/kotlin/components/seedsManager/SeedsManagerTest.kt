...
class SeedsManagerTest {
    ...
    fun `starts crawling correct with clearing all data before`(){
        ...
        verify(mockFrontier).updateOrCreateQueue("https://fucking-internet.com", core.dto.HashedURLPair(seeds[0]).url)
        verify(mockFrontier).updateOrCreateQueue("https://good-internet.com", core.dto.HashedURLPair(seeds[1]).url)
    }
