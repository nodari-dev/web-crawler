...
object RegexPatterns {
    ...
    val META_ROBOTS_FOLLOW = Regex("<meta[^>]*name=\"robots\"[^>]*content=\"[^\"]*\\bindex\\b[^\"]*\"[^>]*>")
    const val META_ROBOTS_FOLLOW_GROUP_INDEX: Int = 0

    val IMAGE_ALT = Regex("<img\\s+alt=\"([^\"]*)\"\\s*>")
    const val IMAGE_ALT_GROUP_INDEX: Int = 1
